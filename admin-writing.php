...
<head>
    <title>EPATS - Writing Admin</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  -->
            <div class="logo">
                ...
                <a href="#" class="simple-text logo-normal">
                    English Proficiency <br />Adaptive Test Series <br /> ADMIN PANEL
                </a>
            </div>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;">
                                    <i class="material-icons">perm_identity</i> John Doe
                                </a>
                            </li>
                            <!-- your navbar here -->
                        </ul>
                                    ...
                                    <form method="post">
                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST["submit"]))
                                            {
                                              ...
                                              $s1=$_POST['q1'];
                                                $sql = "insert into writing(question) values('".$s1."')";
