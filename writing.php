                                        ...
                                        <div class="row app">
                                            <div class="col-md-12">
                                                <form action="writing.php" method="post" >
                                                    ...
                                                    <button class="btn btn-lg btn-primary pull-right" id="submit_answer" name="submit" onclick=" return chk()" type="Submit">Submit</button><br><br>
                                                    <?php
                                                    ...
                                                    // echo $nexttest;
                                                            ...
                                                            $sql = "insert into writing_score(wid,user_id,date_time,marks) values(".$qid.",".$id.",'".$date."',".$nexttest.")";
                                                            

                                                            if(mysqli_query($conn,$sql))
                                                            {
                                                                $_SESSION['w2']= $nexttest;
                                                                echo "<script>window.location.href='writing2.php';
                                                                    </script>";
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card card-chart">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-lg btn-primary btn-block" id="start-record-btn">NEXT TEST</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
