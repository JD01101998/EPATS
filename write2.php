                                            ...
                                            <div class="col-md-12">
                                                <label class="bmd-label-floating" style="font-size: 18px;">
                                                    ...
                                                    <?php
                                                        ...
                                                        $id=$_SESSION['userid'];
                                                        $grp=$_SESSION['group'];
                                                        $qid=$_SESSION['question1'];

                                                        echo "question 2 : qid: ".$qid;
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card card-chart">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-lg btn-primary btn-block" id="start-record-btn" onclick="window.location.href = 'write3.php'">NEXT TEST</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
