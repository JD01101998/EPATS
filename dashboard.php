                            ...
                            <div class="card card-chart">
                                <div class="card-header card-header-success">
                                    <div class="ct-chart" id="websiteViewsChart">
                                        ...
                                        <button onclick="document.getElementById('myImage').src='myfig.png'">Writing</button>
                                        <button onclick="document.getElementById('myImage').src='myfig2.png'">Speaking</button>

                                </div>
                                
                                <div class="card-body">
                                    <h4 class="card-title">Student Progress</h4>
                                    <p class="card-category">Your Performance</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">access_time</i> based on last test
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <a href="quiz.php"><button type="submit" name="submit" class="btn btn-primary pull-right">Take more Tests</button></a>
