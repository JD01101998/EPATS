                                            ...
                                            <div class="col-md-12">
                                                <label class="bmd-label-floating" style="font-size: 18px;">
                                                    ...
                                                    <?php
                                                        ...
                                                        $id=$_SESSION['userid'];
                                                        $grp=$_SESSION['group'];
                                                        $qid=$_SESSION['question2'];

                                                        echo "question 3 : qid: ".$qid;
                                        ...
                                        <div class="row app">
                                            <div class="col-md-12">
                                                <form action="writing.php" method="post">
                                                    ...
                                                    <button class="btn btn-lg btn-primary pull-right" id="submit_answer" name="submit" type="Submit">Submit</button><br><br>
                                                    <?php
                                                    ...
                                                    // echo $nexttest;
                                                            ...
                                                            $sql = "insert into writing_score(wid,user_id,date_time,marks) values(".$qid.",".$id.",'".$date."',".$score.")";

                                                            if(mysqli_query($conn,$sql))
                                                            {
                                                                $_SESSION['w3']= $nexttest;
                                                                //echo "<script>window.location.href='write3.php';
                                                                    //</script>";
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card card-chart">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-lg btn-primary btn-block" id="start-record-btn" onclick="window.location.href = 'write4.php'">NEXT TEST</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
...
<script src="assets/js/writingtimer.js"></script>
