                                            ...
                                            <form  id="speaking" method="post">
                                                ...
                                                // $nexttest=5;
                                                            ...
                                                            {   
                                                                ...
                                                                //echo "<script>window.location.href='speaking3.php';
                                                                  //  </script>";
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card card-chart">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-lg btn-primary btn-block" id="start-record-btn" onclick="window.location.href = 'speaking4.php'">NEXT TEST</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
