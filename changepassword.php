            ...
            <div class="wrapper">
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card" style="position: relative; top: 30%; left: 55%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST["submit"]))
                                        {
                                            ...
                                            $s2=$_POST['new'];
                                            $s3=$_POST['confirm'];
                                            $sql = "SELECT password FROM login_details WHERE email_id = '$id'";
                                        ...
                                        if(mysqli_query($conn,$sql))
                                        {
                                            ...
                                            if($s1==$old_psw and $s2==$s3)
                                            {
                                                $sql = "update login_details set password='".$s2."' where email_id='$id'";
                                                if(mysqli_query($conn,$sql))
                                                {
